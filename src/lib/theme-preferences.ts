export type ThemeCommandId = "ares" | "vulcan" | "apollo" | "aphrodite" | "bacchus" | "tron" | "gaia" | "olympus";

export const THEME_COMMAND_COLORS: Record<ThemeCommandId, string> = {
  ares: "#ff003c",
  vulcan: "#ff7a00",
  apollo: "#ffd400",
  aphrodite: "#ff2ebd",
...
export const THEME_SHADE_COLORS: Record<ThemeCommandId, string[]> = {
